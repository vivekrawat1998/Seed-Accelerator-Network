...
const CoolStatsTables = () => (
    <section className="max-w-7xl grid md:grid-cols-2 grid-cols-1 gap-20 mx-auto my-14 ">
        {/* Region-Wise Participants Table */}
        <div className="bg-white rounded-3xl shadow-2xl md:p-8 p-3 border border-prime relative">
            {/* <span className="absolute top-0 left-0 w-full h-2 rounded-t-3xl bg-prime rounded-2xl" /> */}
            <h2 className="md:text-2xl text-lg font-extrabold text-green-700 mb-7 font-parkinsans text-center tracking-wide">Regions-Wise Participants</h2>
                        ...
                        {regionData.map((row, idx) => (
                            <tr
                                ...
                                className={`${idx % 2 === 0 ? "bg-green-50" : "bg-white"
                                    } hover:bg-emerald-50 text-start font-parkinsans transition`}
                            >
        ...
        <div className="bg-white rounded-3xl shadow-2xl md:p-8  p-3 border border-yellow-700 relative">
            <h2 className="md:text-2xl text-lg font-extrabold text-yellow-700 mb-7 font-parkinsans text-center tracking-wide">Organization Type and Participation</h2>
            <div className="overflow-x-auto">
                <table className="min-w-full text-sm border-separate  border-spacing-y-2">
                    <thead>
                        ...
                        {orgData.map((row, idx) => (
                            <tr
                                ...
                                className={`${idx % 2 === 0 ? "bg-yellow-50" : "bg-white"
                                    } hover:bg-yellow-100 font-parkinsans transition`}
                            >
