    ...
    <section className="bg-white rounded-2xl font-parkinsans px-6 py-10 container mx-auto my-12 ">
      ...
      <div className="flex justify-center mb-10">
        <div className="w-full md:w-4/5 relative rounded-xl overflow-hidden shadow-xl group">
          <img
            src="/In Product Evaluation tab, beside OFT layout (1).webp"
            alt="Product Evaluation"
            className="w-full h-[350px] object-cover transition-transform duration-500 group-hover:scale-105 group-hover:brightness-110"
          />
