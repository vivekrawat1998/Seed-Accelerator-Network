                    ...
                    <form className="space-y-7">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input className="w-full px-3 py-2 rounded text-green-800 border-green-300 border shadow focus:outline-none focus:ring-2 focus:ring-green-300" type="text" placeholder="Your Name" required />
                            </div>
                            <div>
                                <label className="block text-green-800 mb-1 text-sm">Your email*</label>
                                <input className="w-full px-3 py-2 rounded text-green-800 border-green-300 border shadow focus:outline-none focus:ring-2 focus:ring-green-300" type="email" placeholder="Your Email" required />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-green-800 mb-1 text-sm">Your Phone*</label>
                                <input className="w-full px-3 py-2 rounded text-green-800 border-green-300 border shadow focus:outline-none focus:ring-2 focus:ring-green-300" type="text" placeholder="Enter phone*" required />
                            </div>
                            <div>
                                <label className="block text-green-800 mb-1 text-sm">Subject*</label>
                                <input className="w-full px-3 py-2 rounded text-green-800 border-green-300 border shadow focus:outline-none focus:ring-2 focus:ring-green-300" type="text" placeholder="Enter subject*" required />
                            </div>
                        </div>
                        <div>
                            <label className="block text-green-800 mb-1 text-sm">Your message*</label>
                            <textarea className="w-full px-3 py-2 rounded text-green-800 border-green-300 border shadow focus:outline-none focus:ring-2 focus:ring-green-300" rows={4} placeholder="Write message" required />
                        </div>
                        <button className="w-full bg-green-700 text-white font-semibold py-3 rounded-lg hover:bg-green-900 transition mt-4">
                            Send Message
                        </button>
                    </form>
                </div>
